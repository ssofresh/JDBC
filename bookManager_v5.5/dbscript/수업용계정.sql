...
CREATE TABLE BOOK(
    ...
    CONSTRAINT PI_BID PRIMARY KEY (BOOK_ID)
);
...
INSERT INTO BOOK VALUES (SEQ_BID.NEXTVAL, '자바입문', '김유신', '프리랙', TO_DATE('12/02/10', 'RR/MM/DD'), 20000);
INSERT INTO BOOK VALUES (SEQ_BID.NEXTVAL, '자바디자인패턴', '김춘추', '프리랙', TO_DATE('11/09/01', 'RR/MM/DD'), 27000);
